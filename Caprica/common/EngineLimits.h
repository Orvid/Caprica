...
struct EngineLimits final {
  ...
  static void checkLimit(CapricaReportingContext& repCtx,
                         CapricaFileLocation location,
                         Type tp,
                         size_t value,
                         identifier_ref referenceName = "") {
    ...
    switch (tp) {
      ...
      case Type::PexObject_EmptyStateFunctionCount:
        if (exceedsLimit(value, conf::EngineLimits::maxFunctionsInEmptyStatePerObject)) {
          repCtx.warning_W2004_EngineLimits_PexObject_EmptyStateFunctionCount(
              location,
              value,
              conf::EngineLimits::maxFunctionsInEmptyStatePerObject);
        }
        break;
      case Type::PexObject_InitialValueCount:
        if (exceedsLimit(value, conf::EngineLimits::maxInitialValuesPerObject)) {
          repCtx.warning_W2005_EngineLimits_PexObject_InitialValueCount(location,
                                                                        value,
                                                                        conf::EngineLimits::maxInitialValuesPerObject);
        }
        break;
      case Type::PexObject_NamedStateCount:
        if (exceedsLimit(value, conf::EngineLimits::maxNamedStatesPerObject)) {
          repCtx.warning_W2006_EngineLimits_PexObject_NamedStateCount(location,
                                                                      value,
                                                                      conf::EngineLimits::maxNamedStatesPerObject);
        }
        break;
      case Type::PexObject_PropertyCount:
        if (exceedsLimit(value, conf::EngineLimits::maxPropertiesPerObject)) {
          repCtx.warning_W2007_EngineLimits_PexObject_PropertyCount(location,
                                                                    value,
                                                                    conf::EngineLimits::maxVariablesPerObject);
        }
        break;
      case Type::PexObject_StaticFunctionCount:
        if (exceedsLimit(value, conf::EngineLimits::maxStaticFunctionsPerObject)) {
          repCtx.warning_W2008_EngineLimits_PexObject_StaticFunctionCount(
              location,
              value,
              conf::EngineLimits::maxStaticFunctionsPerObject);
        }
        break;
      case Type::PexObject_VariableCount:
        if (exceedsLimit(value, conf::EngineLimits::maxVariablesPerObject)) {
          repCtx.warning_W2009_EngineLimits_PexObject_VariableCount(location,
                                                                    value,
                                                                    conf::EngineLimits::maxVariablesPerObject);
        }
        break;
      ...
      case Type::PexObject_GuardCount:
        if (exceedsLimit(value, conf::EngineLimits::maxGuardsPerObject)) {
          repCtx.warning_W2011_EngineLimits_PexObject_GuardCount(location,
                                                                 value,
                                                                 conf::EngineLimits::maxGuardsPerObject);
        }
        break;
    }
  }
